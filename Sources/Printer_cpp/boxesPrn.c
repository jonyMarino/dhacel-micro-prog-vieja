...
#ifdef RPM
extern const struct EPM203Conf epm203Conf@0x40A2;
#elif defined(_PRINTER) 
extern const struct EPM203Conf epm203Conf@0x409E;
#endif
...
const TDato datoFuente={
  &epm203Conf.fuente,//(int*)&epm203Conf+offsetof(struct EPM203Conf,fuente),							      /* Direccion del parámetro a Escribir*/
...
const TDato datoDireccion={
  &epm203Conf.direccion,//(int*)&epm203Conf+offsetof(struct EPM203Conf,direccion),							      /* Direccion del parámetro a Escribir*/
