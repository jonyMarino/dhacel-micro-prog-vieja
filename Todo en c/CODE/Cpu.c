...
/*
** ===================================================================
**     Nota:    El WDog directamente genera reset, no se cuando entra
**              a esta interrupcion.
** ===================================================================
*/
void  _EntryPointCOP(void) {
  #ifdef debug
  asm(BGND);
  #endif
  _EntryPoint();
...
/*
** ===================================================================
**     Method      :  Lock_interrupt
**
**     Description :   accion cuando se pierde el lock
** ===================================================================
*/
///DDD
...
ISR(Lock_Interrupt)
{
 while(!CRGFLG_LOCK) {                /* Wait until the PLL is within the desired tolerance of the target frequency */
  ...
  setReg8Bits(CRGFLG, 16);              /* Clear lock flag */ 
}
/*
** ===================================================================
**     Method      :  Cpu_Cpu_Interrupt (bean MC9S12GC16_80)
**
**     Description :  accion cuando entra en self clock (No deberia suceder nunca)
** ===================================================================
*/
///DDD
...
ISR(Sclk_Interrupt)
{
 while(!CRGFLG_LOCK) {                /* Wait until the PLL is within the desired tolerance of the target frequency */
  ...
  setReg8Bits(CLKSEL, 128);            /* Select clock source from PLL */ 
  setReg8Bits(CRGFLG, 2);              /* Clear sclk flag */ 
}
...
** ===================================================================
*/
void _Startup(void);            /* Forward declaration of external startup function declared in file Start12.c */
#pragma CODE_SEG __NEAR_SEG NON_BANKED
