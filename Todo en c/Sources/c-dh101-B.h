...
#define SENS_HUMEDAD
/*cantidad de canales 2, canal 1 temp bulbo seco( sensor pt)
canal 2 temp bulbo humedo(sensor HUM).
en el disp2 muestro la humedad% */
//////////////////// MODELOS /////////////////////////////
#define SERIE101
#ifdef SERIE101
#define outc1 0
...
#define numver "A0411 dh101b 1AL  " 


#if defined SENS_HUMEDAD
#define tipoEquipo "   HUm   "
#else
#define tipoEquipo "   Ctb   "
#endif