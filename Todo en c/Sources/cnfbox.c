...
/*Sensor2*/{&PRom[R_Sensor+1],A_Sensor,&Lim_0,&Limite_sensor_Sup,CHAN_2},
 ...
 #ifdef RPM
 /*Decimales1(14)*/{&PRom[R_Decimales],setDecimalesRpm,&Lim_0, &Lim_2,CHAN_1},
 #else
...
#ifdef RPM
/*Filtro1(63)*/{&PRom[R_Filtro1],setFiltro,&Lim_0,&Lim_255,CHAN_1},
#else
...
#ifdef _PRINTER
/*None53(115 o 105)*/{&PRom[R_PrnIntervalo],setIntervaloVista,&Lim_1,&Lim_9999,CHAN_1},
...
/*None58*/{&PRom[R_PrnHabilitado],setHabilitadoVista,&Lim_0,&Lim_2,CHAN_1},
/*None*/{&PRom[R_PrnDireccion],setDireccionVista,&Lim_0,&Lim_2,CHAN_1},
/*None*/{&PRom[R_PrnFuente],setFuenteVista,&Lim_0,&Lim_3,CHAN_1},

#endif

#ifdef RPM
/*None59(120 o 111)*/{&PRom[R_Rpm],setPulsosPorVuelta,&Lim_1,&Lim_9999,CHAN_1},
/*AjusteRPM*/{&PRom[R_AJU],setAjuste,&Lim_m1999,&Lim_9999,CHAN_1},	
#endif
