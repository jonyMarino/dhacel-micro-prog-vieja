...
const word TablaDirs[NUM_DIRS]={                      //direcciones virtuales
  ...
  ((word)&EstatusResult[0]),           //OF/UF1                  (5)
  ((word)&EstatusResult[1]),             //OF/UF2                (6)
  ((word)&ValoresCalculados[0]),         //ValFinal1               (7)
  ((word)&ValoresCalculados[1]),           //ValFinal2             (8)
